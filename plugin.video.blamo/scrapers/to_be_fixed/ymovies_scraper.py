...
BASE_URL = 'https://www1.gomovies.sc/'
...
class Scraper(scraper.Scraper):
    ...
    def __get_links_from_json2(self, url, page_url, video_type):
        ...
        try:
            ...
            logger.log('Exception during ymovies extract: %s' % (e), log_utils.LOGDEBUG)
        return sources
    ...
    def __get_links_from_xml(self, url, video, page_url, cookies):
        ...
        try:
            ...
            for item in root.findall('.//item'):
                ...
                for source in item.findall('{http://yesmovies.co/ajax/movie_sources/'):
            ...
            logger.log('Exception during YMovies XML Parse: %s' % (e), log_utils.LOGWARNING)
