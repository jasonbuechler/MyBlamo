...
ORDER          = ['placenta', 'chappaai', 'death', 'deathrd', 'neptune', 'knob', 'meta', 'royalwe', 'specto', 'trakt']
...
TRAKTID = { 
	...
	'deathrd': {
		...
		'file'     : os.path.join(TRAKTFOLD, 'dsrdplus_trakt'),
	...
	'knob': {
		'name'     : 'The Knob',
		'plugin'   : 'plugin.video.bobomk',
		'saved'    : 'knob',
		'path'     : os.path.join(ADDONS, 'plugin.video.bobomk'),
		'icon'     : os.path.join(ADDONS, 'plugin.video.bobomk', 'icon.png'),
		'fanart'   : os.path.join(ADDONS, 'plugin.video.bobomk', 'fanart.jpg'),
		'file'     : os.path.join(TRAKTFOLD, 'bobomk_trakt'),
		'settings' : os.path.join(ADDOND, 'plugin.video.bobomk', 'settings.xml'),
		'default'  : 'trakt_username',
		'data'     : ['trakt_authorized', 'trakt_username', 'trakt_oauth_token', 'trakt_refresh_token'],
		'activate' : 'RunPlugin(plugin://plugin.video.bobomk/?mode=get_pin)'},
	'meta': {
		'name'     : 'Meta',
